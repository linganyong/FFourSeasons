...
-(void)CreatUI
{
    ...
    [clipBtn setTitle:@"取消" forState:UIControlStateNormal];
    [clipBtn addTarget:self action:@selector(clipBtnCancle:) forControlEvents:UIControlEventTouchUpInside];
    [clipBtn setBackgroundColor:[UIColor whiteColor]];
    [clipBtn setFrame:CGRectMake(0, self.view.frame.size.height - 50, self.view.frame.size.width/2, 50)];
    [clipBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.view addSubview:clipBtn];
    
   
    
    UIButton * clipBtn2 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [clipBtn2 setTitle:@"裁剪" forState:UIControlStateNormal];
    [clipBtn2 addTarget:self action:@selector(clipBtnSelected:) forControlEvents:UIControlEventTouchUpInside];
    [clipBtn2 setBackgroundColor:[UIColor whiteColor]];
    [clipBtn2 setFrame:CGRectMake(self.view.frame.size.width/2, self.view.frame.size.height - 50, self.view.frame.size.width/2, 50)];
    [clipBtn2 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.view addSubview:clipBtn2];
    
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2 - 1, self.view.frame.size.height - 42, 2, 34)];
...
-(void)clipBtnSelected:(UIButton *)btn
{
    ...
    [self clipBtnCancle:btn];
}

-(void)clipBtnCancle:(UIButton *)btn{
